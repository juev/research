...
description: "Сравнение каналов LLM-инференса для агентных систем и разработки: цены, возможности, оплата из России и ограничения."
showToc: true
tocOpen: true
---
...
> **Коротко.** Для непрерывной агентной работы практична мультиканальная схема: GLM-5.3-Flash через z.ai или OpenRouter для экономии, RouterAI — для оплаты в рублях и резервного доступа. Для сложных задач программирования сильнее Claude Opus 5, но он существенно дороже и его подписку нельзя проксировать в сторонние приложения.

**Навигация по обзору:** сначала — цены и стоимость условного агентного дня, затем особенности провайдеров, в конце — готовые схемы выбора, риски и границы данных.
