...
Для реализации мультишагового поиска с декомпозицией вопросов в Open WebUI оптимальный подход — создание Custom Tool (Python) с использованием Native Function Calling [^3] [^16]:
